...
urlpatterns = [
    ...
    # forgot password
    path('forget_password/', auth_views.PasswordResetView.as_view(template_name="account/forgot_password.html", html_email_template_name="account/forgot_password_email.html"), name='password_reset'),

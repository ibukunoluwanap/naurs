...
urlpatterns = [
    ...
    path('studio_user/create/<int:pk>/', views.StudioUserCreate.as_view(), name='dashboard_studio_user_create_page'),
    ...
    path('student_dashboard/get_ticket/<int:order_id>/<ticket_type>/', views.GetTicket.as_view(), name='student_get_ticket'),
    path('student_dashboard/calendar/', views.StudentCalendar.as_view(), name='student_calendar_page'),
    path('tickets/', views.Tickets.as_view(), name='dashboard_tickets_page'),
    path('ticket/<int:pk>/revert/', views.TicketRevert.as_view(), name='dashboard_ticket_revert_page'),
    path('ticket/<int:pk>/delete/', views.TicketDelete.as_view(), name='dashboard_ticket_delete_page'),
    path('notification/', views.Notification.as_view(), name='dashboard_notification_page'),

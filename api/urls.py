...
urlpatterns = [
    ...
    path('password_reset/confirm/done/', views.ResetPasswordConfirmDone.as_view(), name='password_reset_confirm_done_api'),
    ...
    path('get_program/<program_id>/', views.GetProgramAPI.as_view(), name='get_program_api'),
